        ...
        if epoch % 1==0:
            ...
            with torch.no_grad():
                for X,Rx,Y,weight, setidx in Loader_val:
                    ...
                    ##############################################
            dCor_loss = dCor_loss / len(Loader_val)
            if epoch % 10==0:
            ...
            if dCorloss_iepoch < dCorloss_best:
                ...
                torch.save(net.state_dict(), os.path.join(args.save, "dCOR_" + The_DATA_MARK  + "Mloop_" +str(ithres) + '_net_Best' + '_net.pt'))
...
file_net_dict =  os.path.join(args.save, "dCOR_" + The_DATA_MARK  + "Mloop_"  + str(idx_best) + '_net_Best' + '_net.pt')
net = Generator(xdim = P, ndim = args.latent_dim, outdim = 2)
