...
bp_trans_dnn = axs[0].boxplot(dicts[methods[1]], positions=positions_nn, widths=width*2/3, patch_artist=True, boxprops=dict(facecolor=colors[1]), medianprops=dict(color='#000000',linestyle='--'), notch=True)
...
bp_trans_dnn = axs[1].boxplot(dicts[methods[1]], positions=positions_nn, widths=width*2/3, patch_artist=True, boxprops=dict(facecolor=colors[1]), medianprops=dict(color='#000000',linestyle='--'), notch=True)
...
plt.figlegend([bp_trans_dcor["boxes"][0],bp_trans_dnn["boxes"][0]],
               ["TESR","TESR1"], loc='lower center', bbox_to_anchor=(0.5, 0.05),ncol=2, prop={'size': 24})
# plt.tight_layout()
plt.savefig('fig3.png',dpi=300,bbox_inches='tight')
plt.savefig('Simulation_Example3_Test.pdf',bbox_inches='tight')
