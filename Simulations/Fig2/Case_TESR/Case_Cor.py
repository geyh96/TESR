    ...
    for epoch in range(args.nEpochs):
        ...
        if epoch % 1==0:
            ...
            if dCorloss_iepoch < dCorloss_best:
                ...
                torch.save(net.state_dict(), os.path.join(args.save, "dCOR_idata_" + The_DATA_MARK  + "Model_iloop_" +str(ithres) + '_n_Best' + '_net.pt'))
...
file_net_dict =  os.path.join(args.save, "dCOR_idata_" + The_DATA_MARK  + "Model_iloop_"  + str(idx_best) + '_n_Best' + '_net.pt')
net = Generator(xdim = P, ndim = args.latent_dim, outdim = 2)
    ...
    for epoch in range(args.nEpochs):
        ...
        if epoch % 1==0:
            ...
            if loss_iepoch < loss_best:
                ...
                torch.save(net_Target.state_dict(), os.path.join(args.save, "dCOR_net2_idata_" + The_DATA_MARK + "Model_iloop_" +str(ithres) + '_n_Best' + '_net.pt'))
...
print(list_tuning[idx_best2])
file_net_dict =  os.path.join(args.save, "dCOR_net2_idata_" + The_DATA_MARK  + "Model_iloop_"  + str(idx_best2) + '_n_Best' + '_net.pt')
...
for epoch in range(args.nEpochs_pred):
    ...
    if epoch % 1==0:
        ...
        if loss_iepoch < loss_best:
            ...
            loss_best = loss_iepoch
            torch.save(f1_pred_from_Rx.state_dict(), os.path.join(args.save, "dCORpred_idata_" + The_DATA_MARK  + "Model_iloop_"  + str(1) + '_f1_Best'  + '_net.pt'))


file_net_dict = os.path.join(args.save, "dCORpred_idata_" + The_DATA_MARK  + "Model_iloop_"  + str(1) + '_f1_Best'  + '_net.pt')
f1_pred_from_Rx = pred_from_Rx(args.latent_dim*2,outdim =  2)
