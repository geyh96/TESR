...
# list_NT = [1000, 1500, 2000, 2500, 3000]
...
methods = ["TESR","TESR1"]
folders = [ "./Case_TESR/result/","./Case_TESR1/result/"]
...
for i in range(3):
    for j in range(2):
        ...
        axs[i].set_ylabel(r'MSE', fontsize=24)
...
# list_NS = [2000,4000,6000,8000,10000]
list_NT = [500]
dicts = {}
for i in range(2):
...
for i in range(3):
    for j in range(2):
        ...
        axs[3+i].set_ylabel(r'MSE', fontsize=24)
...
# plt.tight_layout()
# plt.show()
plt.savefig('Simulation_ExampleS1_Test.pdf',dpi=500)
